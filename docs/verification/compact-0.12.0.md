...
- Native app showed 0.12.0 and its in-app update. The compact orb visibly expanded into recording controls. Character + particles was selected through native Appearance controls and visibly collapsed into the small character. Local correction learning was enabled through Writing. The personal correction direction was verified as Louise → Luis; the backwards rules and incorrect custom word were removed.
