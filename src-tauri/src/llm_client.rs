...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/Dreydrey9000/say-less"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("SayLess/1.0 (+https://github.com/Dreydrey9000/say-less)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Say Less"));
